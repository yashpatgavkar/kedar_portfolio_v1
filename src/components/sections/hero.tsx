  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto min-h-screen w-full max-w-[1500px] px-6 pb-16 pt-28 sm:px-10 md:px-14 md:pb-24 lg:px-20">
        ...
        <div className="pointer-events-none absolute inset-x-5 top-24 z-0 flex items-start justify-center gap-[clamp(3.5rem,11vw,13rem)] font-display text-[clamp(4.2rem,12.5vw,12.5rem)] font-extrabold leading-[0.72] tracking-[-0.08em] text-red-700/90 sm:inset-x-10 md:inset-x-16 md:top-28 lg:inset-x-20">
          <span>ABOUT</span>
          <span>ME</span>
        </div>
        ...
        <div className="grid min-h-[calc(100vh-7rem)] grid-cols-1 pt-24 md:grid-cols-[minmax(520px,0.92fr)_minmax(380px,1.08fr)] md:pt-0">
          <section className="relative z-10 grid max-w-[860px] grid-cols-1 content-end gap-8 self-end md:grid-cols-[minmax(235px,0.85fr)_minmax(230px,0.72fr)] md:gap-12">
            ...
            <div>
              ...
              <h1 className="font-display text-[clamp(4.5rem,7vw,7.6rem)] font-extrabold leading-[0.78] tracking-[-0.09em] text-foreground">
                KEDAR
                <br />
                DIXIT
              </h1>
            ...
            <div className="flex flex-col justify-end">
              ...
              <div className="mt-8 flex items-start gap-3">
                ...
                <p className="max-w-[15rem] text-base leading-[1.35] text-foreground sm:text-lg">
              ...
              <div className="mt-6 divide-y divide-border/50 border-y border-border/50">
                {stats.map((stat) => (
                  <div key={stat.label} className="flex items-center gap-3 py-2">
                    <span className="font-display text-3xl font-extrabold tracking-[-0.08em] text-red-600">
                      {stat.value}
                    </span>
                    <span className="text-[10px] font-medium uppercase leading-[1.2] tracking-wide text-foreground/90">
                      {stat.label}
                    </span>
                  </div>
                ))}
