...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Hitendra Consultancy (OPC) Pvt. Ltd.",
    description: [
      "Designed engaging social media creatives, banners, posters, flyers, and marketing materials for multiple client campaigns.",
      "Developed branding assets including logos, business cards, and visual identity elements to strengthen brand recognition.",
      "Collaborated with clients to transform ideas into high-quality, visually appealing designs while meeting project deadlines.",
      "Delivered creative assets optimized for both digital and print media, ensuring consistent branding across platforms.",
    ],
    skills: [
  ...
  },
  {
    ...
    description: [
      "Designed digital brochures, visual reports, and marketing materials for corporate and government projects.",
      "Developed brand identity assets and corporate design elements to maintain consistent visual communication.",
      "Created professional presentation decks for PWD and corporate clients, enhancing project presentations.",
      "Collaborated with teams to deliver high-quality creative assets while meeting tight deadlines.",
    ],
    skills: [
